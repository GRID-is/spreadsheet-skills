...
Generated from `@grid-is/agent-tools@0.3.0` (`dist/tools.d.ts`). Every public symbol listed here exists in that version. If the installed version differs, read `node_modules/@grid-is/agent-tools/dist/tools.d.ts` instead; it is the source of truth.
